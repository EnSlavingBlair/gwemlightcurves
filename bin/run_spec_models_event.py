...
def parse_commandline():
    ...
    parser.add_argument("--mej",default=0.035,type=float)
    parser.add_argument("--vej",default=0.15,type=float)
    parser.add_argument("--Xlan",default=1e-2,type=float)

    parser.add_argument("--mej1",default=0.035,type=float)
    parser.add_argument("--vej1",default=0.15,type=float)
    parser.add_argument("--Xlan1",default=1e-2,type=float)

    parser.add_argument("--mej2",default=0.020,type=float)
    parser.add_argument("--vej2",default=0.30,type=float)
    parser.add_argument("--Xlan2",default=1e-5,type=float)
